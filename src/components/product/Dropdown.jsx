...
const Dropdown = ({ firstItem, menuItems, type, productID }) => {
  ...
  return (
    <Menu as="div" className={`relative w-full text-center ${darkMode?'text-white' : 'text-black'}`}>
      ...
      >
        <Menu.Items className={` ${darkMode? 'bg-slate-700' : 'bg-white'} absolute right-0 w-full  z-[55] mt-3 origin-top-right divide-y divide-gray-100 rounded-sm shadow-5xl ring-1 ring-black ring-opacity-5 focus:outline-none `}>
