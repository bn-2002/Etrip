...
const Footer = () => {
  ...
  return (
    <footer
      id="footer"
      className={`flex flex-col items-center justify-center gap-5 py-10 ${darkMode ?'bg-[#0f172a]' : 'bg-[#1E1E1E]'} p-4 z-[19] relative`}
    >
      ...
      <span className={`${darkMode ? 'text-slate-400' : 'text-[#4E4E4E]'} text-[16px] text-center`}>
